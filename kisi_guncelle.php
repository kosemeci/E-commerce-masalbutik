...
<body class="app sidebar-mini">
        ...
        <ul class="app-menu">
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Siparişler</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="siparis_g.php"><i class="icon bi bi-circle-fill"></i> Gerçekleşen Siparişler</a></li>
                    <li><a class="treeview-item" href="siparis_b.php" target="_blank" rel="noopener"><i class="icon bi bi-circle-fill"></i> Bekleyen Siparişler</a></li>
                </ul>
            </li>
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="bi bi-folder-plus"></i> Kişi Güncelle</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
                <li class="breadcrumb-item"><a href="#">Kişi Güncelle</a></li>
            </ul>
        </div>
        <h2>Kişi Güncelleme Formu</h2>
        <div class="search-container" >
        <input type="text" id="searchUser" placeholder="Kullanıcı mail yada tel no girin...">        
            <button type="button" onclick="searchUser()">Ara</button>
        </div>
        <form>
            <table>
                <tr>
                    <td>Ad-Soyad:</td>
                    <td><input type="text" name="user_ad"></td>
                </tr>
                
                <tr>
                    <td>Telefon No:</td>
                    <td><input type="number" name="tel_number"></td>
                </tr>
                <tr>
                    <td>Mail:</td>
                ...
                <tr>
                    <td>Üyelik Durumu: <br> <p style="font-size: smaller;">0-Pasif Üye, 1-Aktif Üye, 2-Yönetici</p></td>
                    <td><input type="number" id="user_case" name="user_case" min="0" max="2"></td>
